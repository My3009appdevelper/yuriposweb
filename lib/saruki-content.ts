...
export const sarukiModules: readonly SarukiModule[] = [
  ...
  },
  {
    ...
    category: "Venta",
    name: "Venta a granel",
    summary: "Vende por cantidad y adapta el cobro a productos que se despachan a granel.",
    audiences: ["general", "farmacias", "abarrotes"],
    plan: "Esencial",
    icon: "scale",
    visualAsset: "/assets/modulos-webp/a granel.webp",
  },
  {
    id: "venta-presentaciones",
    category: "Venta",
    name: "Venta por presentaciones",
    summary: "Vende por pieza, caja o presentación con una lógica clara para cada producto.",
    audiences: ["general", "farmacias", "abarrotes"],
    plan: "Esencial",
    icon: "package",
    visualAsset: "/assets/modulos-webp/venta por presentaciones.webp",
  },
  {
    id: "clientes",
    category: "Venta",
